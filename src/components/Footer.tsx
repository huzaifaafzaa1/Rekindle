...
export default function Footer() {
  return (
    <footer className="mt-10 py-6 mx-auto w-[90%] lg:w-[75%]">

      <div className=" flex flex-col gap-2 lg:justify-evenly xl:flex-row">
        ...
        <div className="my-2 p-2 flex flex-col items-center xl:items-end text-center xl:text-right">
          ...
          <div className="flex items-center justify-center border rounded-lg px-4 py-2 my-4 cursor-pointer">
            {/* Country Flag */}
            <div className="flex justify-between items-center w-[24px] h-[16px]"><Image src="/images/canada.svg" alt="Canada Flag" width={24} height={16} /></div>
            {/* Country Name */}
            <input type="text" value="Canada" readOnly className="ml-2 font-medium  cursor-pointer"/>
            {/* Dropdown Arrow */}
