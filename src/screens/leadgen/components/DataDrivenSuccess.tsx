...
const DataDrivenSuccess = () => {
  return (
    <div className="mt-3 md:mt-20 flex flex-col md:flex-row gap-10 justify-center items-center border-2 border-solid border-black">
        <div className="flex flex-col justify-center p-6 ">
            ...
            <h1 className="text-2xl md:text-3xl font-semibold text-gray-900">Over 40,000 Monthly for <br /> 450 Dealerships Nationwide</h1>
            <div className="mt-10">
